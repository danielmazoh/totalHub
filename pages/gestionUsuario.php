            ...
            <div class="row">
                ...
                <fieldset>
                    <legend>Registrar Sede</legend>
                        ...
                        <input type="text" name="telefonoSedeSolicitada" class="form-control" required="required">
                        <label>Mail</label>
                        <input type="text" name="mailSedeSolicitada" class="form-control" required="required">
                        <label>Dirección</label>
                        <input type="text" name="direccionSedeSolicitada" class="form-control" required="required">
                        <label>Representante</label>
                        <input type="text" name="representanteSedeSolicitada" class="form-control" required="required">
                        <label>Representante</label>
                        <select name="estadoSedeSolicitada" class="form-control">
                            <option value="1">Activa</option>
                            <option value="2">Inactiva</option>
                        </select>
                        <br>
                        <input type="submit" value="Guardar Modalidad" class="btn btn-success" >
                        </form>
                </fieldset>
                </div>
                <div class="col-lg-8">

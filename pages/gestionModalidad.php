    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-4">
                <fieldset>
                    <legend>Registrar Modalidad</legend>
                        <form method="post" action="">
                        
                        <label>Nombre Modalidad</label>
                        <input type="text" name="nombreModalidadSolicitada" id="nombreModalidadSolicitada" class="form-control" required="required">
                        <label>Estado de la Modalidad</label>
                        <select name="estadoModalidadSolicitado" id="estadoModalidadSolicitado" class="form-control" required="required">
                            <option value="1">Activo</option>
                            <option value="2">Inactivo</option>
                        </select>
                        <br>
                        <input type="submit" value="Guardar Modalidad" class="btn btn-success" onclick="guardarModalidad()">
                        </form>
                </fieldset>
                </div>
                <div class="col-lg-8">
